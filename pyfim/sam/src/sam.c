...
#define VERSION     "version 3.16 (2016.04.09)        " \
                    "(c) 2008-2016   Christian Borgelt"
...
{                               /* --- main function */
  ...
  #endif  /* #ifndef QUIET */
  /* free option characters: ijlop [A-Z]\[CFNPRTZ] */
  ...
  sins = (sins >= 0) ? sins/100.0 *(double)w *(1-DBL_EPSILON) : -sins;
